        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    var userName = loginInfo.ExternalIdentity.FindFirstValue(ClaimTypes.Name);
                    var birthdayString = loginInfo.ExternalIdentity.FindFirstValue(ClaimTypes.DateOfBirth);
                    var birthday = string.IsNullOrEmpty(birthdayString) ? DateTime.MinValue : DateTime.Parse(birthdayString);
                    var genderString = loginInfo.ExternalIdentity.FindFirstValue(ClaimTypes.Gender);
                    Gender gender;
                    ...
                    var location = loginInfo.ExternalIdentity.FindFirstValue(ClaimTypes.Locality);
                    string parsedLocation = null;

                    if (location != null)
                    {
                        dynamic locationData = JObject.Parse(location);
                        parsedLocation = locationData.name;
                    }
